  ...
  return (
    <LoadScriptNext googleMapsApiKey={apiKey} language="en">
      <GoogleMap
        ...
        center={center}
        zoom={12}
        key={apiKey} // 🔑 force remount when switching tabs
      >
              ...
              {serviceData ? (
                <>
                  <ul>
                    <li>
                      <p>
                        <strong>Nearest bus distance: </strong>{" "}
                        {serviceData.nearestBusStopDist} mi
                      </p>
                    </li>
                    <li>
                      <p>
                        <strong>Nearest bike distance: </strong>{" "}
                        {serviceData.nearestBikeDist} mi
                      </p>
                    </li>
                    <li>
                      <p>
                        <strong>Median neighborhood income: </strong> $
                        {serviceData.median_income}
                      </p>
                    </li>
                  </ul>
                  ...
                  <p>
                    ...
                    {(serviceData.A * 10).toFixed(1)}/10
                  </p>
                  <p>
                    <strong>Criticality:</strong>{" "}
                    {(serviceData.C * 10).toFixed(1)}/10
                  </p>
                  <p>
                    <strong>Service Score:</strong>{" "}
                    {(serviceData.G * 10).toFixed(1)}/10
                  </p>
                </>
              ) : (
                <p>loading</p>
